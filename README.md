...
- 기존 LAB-03~26의 원래 결과 구조를 유지하고, 신규 LAB-27~100은 질문 4개·결과 4개·추천 이유·실행 3단계·대안 결과·저장·공유를 제공합니다.
...
- LAB-27~100 질문 4개·결과 4개
- 기존 LAB-03~26의 원래 결과 구조
- 각 LAB의 번호·slug 중복, HTML 구조·CSS 누락 여부
- 통합 허브 필수 파일
